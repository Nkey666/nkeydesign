    ...
    >
      ...
      <SpotlightCard className="rounded-3xl border border-border bg-surface/60 p-8 text-center backdrop-blur-sm md:p-12">
        ...
        <div className="mx-auto mt-4 max-w-2xl space-y-4 text-[15px] leading-relaxed text-muted">
          <p>
            Фронтенд-разработчик из Москвы. Три года делаю современные сайты,
            веб-приложения и корпоративные порталы — быстрые, удобные и надёжные
            интерфейсы, которые помогают бизнесу привлекать клиентов.
          </p>
          <p>
            Работаю на современном стеке:{" "}
            <span className="font-medium text-fg">
              Next.js, React, TypeScript, Tailwind CSS
            </span>
            , анимации на Motion и GSAP. Особое внимание — производительности
            (Core Web Vitals), качеству кода и деталям реализации.
          </p>
          <p>
            Готовлю проекты под ИИ-поиск, чтобы компании получали клиентов не
            только из Яндекса и Google, но и из нейросетей вроде ChatGPT.
            Моя цель — продукты, которые хорошо выглядят и приносят реальную
            пользу бизнесу.
          </p>
        </div>
